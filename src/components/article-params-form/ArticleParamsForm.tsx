...
export const ArticleParamsForm = (props: ArticleParamsProps) => {
	...
	return (
		<>
			<div onClick={() => setIsMenuOpen(false)} className={clsx(styles.overlay, isMenuOpen && styles.overlay_open)}></div>
			<ArrowButton isActive={isMenuOpen} onClick={() => setIsMenuOpen	((currentIsOpened) => !currentIsOpened)}/>
